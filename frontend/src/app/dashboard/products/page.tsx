...
export default function ProductsPage() {
  return (
    <div className="p-8 h-screen overflow-y-auto">
      <h1 className="text-2xl font-bold text-text-primary mb-6">Products</h1>
      <div className="bg-bg-secondary border border-border rounded-xl shadow-lg p-8 flex flex-col items-center justify-center h-96">
        <h3 className="text-xl font-medium text-text-primary mb-2">Products Management</h3>
        <p className="text-text-secondary mb-6 text-center max-w-md">
          This UI is under construction. For now, please use the AI Assistant to manage products.
        </p>
